  ...
  Backstory: [
    {
      title: "Origin",
      content:
        "Treat wasn’t born with knowledge of his technique. He nearly died discovering it—ripped apart and rewired by his own glitch.",
    },
    {
      title: "Rebirth",
      content:
        "After that death, he returned. Muzzled. Rewritten. Alive again not out of mercy, but out of defiance.",
    },
  ],
  Personality: [
    {
      title: "Disposition",
      content:
        "Gojo-like: confident, unbothered, sarcastic—but deeply observant and protective of those with potential.",
    },
    {
      title: "Philosophy",
      content:
        "He believes strength without freedom is slavery. And he won’t let the higher-ups kill another kid under their rule.",
    },
  ],
};
